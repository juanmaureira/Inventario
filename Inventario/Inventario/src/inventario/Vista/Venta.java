...
public class Venta extends javax.swing.JDialog {
    ...
    public Venta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtm = (DefaultTableModel) tbVenta.getModel();
    ...
    private void initComponents() {
        ...
        tbVenta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Fecha", "Nombre", "Monto", "% Descuento"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        montoFinal = txtMonto.getText();
        
        if( nombre.isEmpty() || id.isEmpty() || fecha.isEmpty() || descuento.isEmpty() || montoFinal.isEmpty()){
            Warning warning = new Warning(new javax.swing.JDialog(),true);
            warning.setVisible(true);
            
        }else{
            ventaClass venta = new ventaClass(id, fecha, nombre, descuento, montoFinal);
            
            o[0] = venta.getId();
            o[1] = venta.getNombre();
            o[2] = venta.getFecha();
            o[3] = venta.getMontoFinal();
            o[4] = venta.getDescuento();
